...
products.splice(0, products.length,
  { id: 1, name: 'REMERA REGULAR', type: 'ALGODÓN 24.1 / UNISEX', category: 'REMERAS REGULAR', price: null, colors: ['#181818','#f7f7f2','#e3d5bf','#d8c4a0','#55524f','#62616a','#b5b5b0','#4a4a4a','#d6b27c','#1062b7','#172d49','#8bc8e7','#087d83','#1f653e','#4b5320','#94b7df'], colorNames: ['NEGRO','BLANCO','NATURAL','BEIGE','GRIS TOPO','GRIS GRAFITO','GRIS MELANGE','GRIS OSCURO','ARENA','AZUL FRANCIA','AZUL MARINO','CELESTE','PETRÓLEO','VERDE INGLÉS','VERDE MILITAR','AZUL AÉREO'], sizes: ['S','M','L','XL','XXL'], image: 'tee', images: ['./assets/products/p4-0.png','./assets/products/p4-1.png','./assets/products/p4-2.png','./assets/products/p4-3.png','./assets/products/p4-4.png','./assets/products/p4-5.png','./assets/products/p4-6.png','./assets/products/p4-7.png','./assets/products/p4-8.png','./assets/products/p5-0.png','./assets/products/p5-1.png','./assets/products/p5-2.png','./assets/products/p5-3.png','./assets/products/p5-4.png','./assets/products/p5-5.png','./assets/products/p5-6.png'] },
  { id: 2, name: 'REMERA OVERSIZE', type: 'ALGODÓN 24.1 / UNISEX', category: 'OVERSIZE', price: null, colors: ['#181818','#f7f7f2','#b5b5b0','#eee4d4','#dcc79b','#50372c','#e0c66e','#676c72','#41506a','#25285e','#0f58c5','#b8d8e4','#183c23','#4d512a','#c5a9e4','#5535a5','#67b5d8','#722538','#eb1818','#f1a7af'], colorNames: ['NEGRO','BLANCO','GRIS MELANGE','NATURAL','BEIGE','CHOCOLATE','BEIGE FUERTE','GRIS TOPO','AZUL MARINO','AZUL MARINO OSCURO','AZUL FRANCIA','CELESTE','VERDE INGLÉS','VERDE MILITAR','LILA','VIOLETA','AZUL AÉREO','BORDO','ROJO','ROSA'], sizes: ['S','M','L','XL'], image: 'core', images: ['./assets/products/p11-0.png','./assets/products/p11-1.png','./assets/products/p11-2.png','./assets/products/p11-3.png','./assets/products/p11-4.png','./assets/products/p11-5.png','./assets/products/p11-6.png','./assets/products/p11-7.png','./assets/products/p11-8.png','./assets/products/p12-0.png','./assets/products/p12-1.png','./assets/products/p12-2.png','./assets/products/p12-3.png','./assets/products/p12-4.png','./assets/products/p12-5.png','./assets/products/p12-6.png','./assets/products/p12-7.png','./assets/products/catalog-13-0.png','./assets/products/catalog-13-1.png','./assets/products/catalog-13-2.png'] },
  { id: 11, name: 'MUSCULOSA OVERSIZE', type: 'ALGODÓN 24.1 / UNISEX', category: 'OVERSIZE', price: null, colors: ['#181818','#f7f7f2','#172d49'], colorNames: ['NEGRO','BLANCO','AZUL MARINO'], sizes: ['S','M','L','XL'], image: 'tee', images: ['./assets/products/catalog-15-0.png','./assets/products/catalog-15-1.png','./assets/products/catalog-15-2.png'] },
  { id: 8, name: 'REMERA CORTE MUJER', type: 'ALGODÓN 24.1', category: 'MUJER', price: null, colors: ['#1d1d1d','#172d49','#fafafa','#f0ebdd','#dfc05d'], colorNames: ['NEGRO','AZUL MARINO','BLANCO','NATURAL','BEIGE'], sizes: ['S','M','L','XL','XXL'], image: 'tee', images: ['./assets/products/catalog-21-0.png','./assets/products/catalog-21-1.png','./assets/products/catalog-21-2.png','./assets/products/catalog-21-3.png','./assets/products/catalog-21-4.png'] },
  { id: 12, name: 'PUPERA OVERSIZE', type: 'ALGODÓN 24.1', category: 'MUJER', price: null, colors: ['#181818','#f0ebdd','#fafafa','#9cccf0','#ed9084','#c0afe3'], colorNames: ['NEGRO','NATURAL','BLANCO','CELESTE','ROSA CORAL','LILA'], sizes: ['ÚNICO'], image: 'core', images: ['./assets/products/catalog-23-0.png','./assets/products/catalog-23-1.png','./assets/products/catalog-23-2.png','./assets/products/catalog-23-3.png','./assets/products/catalog-23-4.png','./assets/products/catalog-23-5.png'] },
  { id: 13, name: 'MUSCULOSA', type: 'ALGODÓN 24.1', category: 'MUJER', price: null, colors: ['#181818','#f0ebdd','#fafafa','#dcaf91','#e4a33d','#e8a9bd','#172d49','#753ac2','#c8b7d4'], colorNames: ['NEGRO','NATURAL','BLANCO','BEIGE','BEIGE FUERTE','ROSA','AZUL MARINO','VIOLETA','LILA'], sizes: ['S','M','L','XL'], image: 'tee', images: ['./assets/products/catalog-25-0.png','./assets/products/catalog-25-1.png','./assets/products/catalog-25-2.png','./assets/products/catalog-25-3.png','./assets/products/catalog-25-4.png','./assets/products/catalog-25-5.png','./assets/products/catalog-25-6.png','./assets/products/catalog-25-7.png','./assets/products/catalog-25-8.png'] },
  { id: 7, name: 'BERMUDA OVERSIZE', type: 'RÚSTICO PEINADO', category: 'BERMUDAS', price: null, colors: ['#181818','#b5b5b0'], colorNames: ['NEGRO','GRIS'], sizes: ['S','M','L','XL'], image: 'core', images: ['./assets/products/catalog-18-0.png','./assets/products/catalog-18-1.png'] },
  { id: 9, name: 'CHOMBA', type: 'PIQUÉ PEINADO', category: 'CHOMBAS', price: null, colors: ['#181818','#b5b5b0','#fafafa','#172d49','#74101b'], colorNames: ['NEGRO','GRIS','BLANCO','AZUL MARINO','BORDO'], sizes: ['2','3','4','5','6','8'], image: 'tee', images: ['./assets/products/catalog-27-0.png','./assets/products/catalog-27-1.png','./assets/products/catalog-27-2.png','./assets/products/catalog-27-3.png','./assets/products/catalog-27-4.png'] },
  { id: 10, name: 'REMERA DE NIÑOS', type: 'ALGODÓN 24.1', category: 'NIÑOS', price: null, colors: ['#181818','#fafafa','#172d49','#125196','#126144','#a8d8ef','#3c5666','#505326','#bc2a30','#821522','#ed7bac','#4b342a','#eee5cf'], colorNames: ['NEGRO','BLANCO','AZUL MARINO','AZUL FRANCIA','VERDE INGLÉS','CELESTE','GRIS GRAFITO','VERDE MILITAR','ROJO','BORDO','ROSA','CHOCOLATE','NATURAL'], sizes: ['4','6','8','10','12','14','16'], image: 'tee', images: ['./assets/products/p31-0.png','./assets/products/p31-1.png','./assets/products/p31-2.png','./assets/products/p31-3.png','./assets/products/p31-4.png','./assets/products/p31-5.png','./assets/products/p31-6.png','./assets/products/p31-7.png','./assets/products/catalog-32-0.png','./assets/products/catalog-32-1.png','./assets/products/catalog-32-2.png','./assets/products/catalog-32-3.png','./assets/products/catalog-32-4.png'] },
  { id: 3, name: 'BUZO REGULAR', type: 'FRIZA PREMIUM', category: 'BUZOS', price: null, colors: ['#181818','#172d49','#b5b5b0','#4b4b4b','#17613f'], colorNames: ['NEGRO','AZUL MARINO','GRIS MELANGE','GRIS TOPO JASPEADO','VERDE INGLÉS'], sizes: ['S','M','L','XL','XXL'], image: 'hoodie', images: ['./assets/products/p35-0.png','./assets/products/p35-1.png','./assets/products/p35-2.png','./assets/products/p35-3.png','./assets/products/p35-4.png'] },
  { id: 4, name: 'BUZO OVERSIZE', type: 'FRIZA PREMIUM', category: 'BUZOS', price: null, colors: ['#181818','#b5b5b0','#e5ddd1','#4b4b4b','#dccdb8','#b1858b','#704646','#a5abb0','#ee2436','#721e27','#8e5269','#bf7782','#f7d0d0','#d8cbed','#c5daed','#789ac6','#172d49','#17613f'], colorNames: ['NEGRO','GRIS MELANGE','NATURAL','GRIS TOPO JASPEADO','BEIGE','ROSA VIEJO','CHOCOLATE','GRIS','ROJO','BORDO','BORDO VIEJO','ROSA VIEJO','ROSA','LILA','CELESTE CLARO','AZUL AÉREO','AZUL MARINO','VERDE INGLÉS'], sizes: ['S','M','L','XL'], image: 'hoodie', images: ['./assets/products/p37-0.png','./assets/products/p37-1.png','./assets/products/p37-2.png','./assets/products/p37-3.png','./assets/products/p37-4.png','./assets/products/p37-5.png','./assets/products/p37-6.png','./assets/products/p37-7.png','./assets/products/p37-8.png','./assets/products/catalog-38-0.png','./assets/products/catalog-38-1.png','./assets/products/catalog-38-2.png','./assets/products/catalog-38-3.png','./assets/products/catalog-38-4.png','./assets/products/catalog-38-5.png','./assets/products/catalog-38-6.png','./assets/products/catalog-38-7.png','./assets/products/catalog-38-8.png'] },
  { id: 5, name: 'CUELLO REDONDO', type: 'FRIZA PREMIUM', category: 'BUZOS', price: null, colors: ['#181818','#e5ddd1','#b5b5b0','#c46962','#704646','#d7bf92','#9aa0a4','#c4b3dc','#a9adb2','#9ed5e5','#7896c4','#172d49','#17613f'], colorNames: ['NEGRO','NATURAL','GRIS MELANGE','CORAL','CHOCOLATE','BEIGE','GRIS','LILA','GRIS TOPO','CELESTE','AZUL AÉREO','AZUL MARINO','VERDE INGLÉS'], sizes: ['S','M','L','XL','XXL'], image: 'hoodie', images: ['./assets/products/p40-0.png','./assets/products/p40-1.png','./assets/products/p40-2.png','./assets/products/p40-3.png','./assets/products/p40-4.png','./assets/products/p40-5.png','./assets/products/p40-6.png','./assets/products/p40-7.png','./assets/products/p40-8.png','./assets/products/catalog-41-0.png','./assets/products/catalog-41-1.png','./assets/products/catalog-41-2.png','./assets/products/catalog-41-3.png'] },
  { id: 6, name: 'CAMPERA DE FRIZA', type: 'FRIZA PREMIUM', category: 'BUZOS', price: null, colors: ['#181818'], colorNames: ['NEGRO'], sizes: ['S','M','L','XL','XXL'], image: 'hoodie', images: ['./assets/products/p43-0.png'] }
);
...
uxStyle.textContent = `
  ...
  .hero-word-strip { display: block; will-change: transform, filter; }
  .hero-word-item { display: block; height: 1em; width: 100%; white-space: nowrap; line-height: 1; }
  ...
  .swatches { align-items: center; flex-wrap: wrap; row-gap: 9px; }
...
if (heroWord && !window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
  ...
  window.balanceHeroWordTimer = setInterval(() => {
    if (heroWord.dataset.rolling === 'true') return;
    const wordItem = heroWord.querySelector('.hero-word-item');
    if (!wordItem) return;
    const currentWord = wordItem.textContent;
    heroWordIndex = (heroWordIndex + 1) % heroWords.length;
    const nextWord = heroWords[heroWordIndex];
    const strip = document.createElement('span');
    strip.className = 'hero-word-strip';
    strip.innerHTML = `<span class="hero-word-item">${currentWord}</span><span class="hero-word-item">${nextWord}</span>`;
    heroWord.dataset.rolling = 'true';
    ...
    roll.finished.then(() => {
      heroWord.innerHTML = `<span class="hero-word-item">${nextWord}</span>`;
      delete heroWord.dataset.rolling;
    });
  }, 2100);
}
renderProducts();
